...
% x_{1,2} = +/- 1.5. The resultings bumps merge into one bump, i.e.
% we observe bump attraction.
%
% See Fig. 14 in 'A dynamic neural field model of continuous input integration'
...
%% inputs
crit_dist = 1.5;  % distance of the input centers from x=0
A_I = 1.5; sigma_I = 1.0;
Input = zeros(M, N);
