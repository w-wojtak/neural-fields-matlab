...
% with input.
%
% The spatial convolution of w and f is computed using Matlab's 'conv'
% function.
%
...
for i = 1:M
    ...
    output = [f(half_point + 2:numel(xDim)), f, f(:, 1:half_point)];        
    convolution = dx * conv(output, w, 'valid');    
